...
CSS3 Moderno: Implementação de variáveis globais (:root), layouts em Grid e Flexbox, e design adaptativo para dispositivos móveis.

Interatividade: Scripts em JavaScript para controle de animações de entrada (scroll-reveal) e manipulação de classes do DOM(Document Object Model).
...
scripts/: Pasta contendo a lógica de animações do projeto.

assets/: Diretório de recursos visuais (logotipos, ícones e fotografias).
